...
//using world coordinates
	...
	read_model_matrix[3].xyz = double_add_vec3(model_origin, model_precision, inv_view_matrix[3].xyz, view_precision, temp_precision);
	modelview[3].xyz = mat3(read_view_matrix) * read_model_matrix[3].xyz;
#else
	mat4 modelview = read_view_matrix * model_matrix;
#endif
